# 0. Padrões de Projeto e Nomenclatura - AZJOB-0.0.10-SNAPSHOT(Monolito)
...
## 0.6 Banco de Dados e Persistência
...
### 0.9.7 Padrão de retorno Sucesso e Erro
```json
    {
        "success": false,
